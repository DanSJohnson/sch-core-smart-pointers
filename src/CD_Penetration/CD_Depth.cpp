...
inline int originInTetrahedron(const Vector3 & p1, const Vector3 & p2, const Vector3 & p3, const Vector3 & p4)
{
...
#ifdef SCH_BUILD_BSD
Scalar CD_Depth::getPenetrationDepth(Vector3 &,
                                     Point3 &,
                                     Point3 &,
                                     const CD_SimplexEnhanced &,
                                     const CD_Simplex &,
                                     const CD_Simplex &)
{
  return 0;
...
Scalar CD_Depth::getPenetrationDepth(Vector3 & v,
                                     Point3 & p1,
                                     Point3 & p2,
  ...
  switch(num_verts)
  {
    ...
    case 4:
    {
      ...
      if(bad_vertex == 0)
      {
        ...
        if(!(f0 && f0->getDist2() > Scalar(0.0) && f1 && f1->getDist2() > Scalar(0.0) && f2
             && f2->getDist2() > Scalar(0.0) && f3 && f3->getDist2() > Scalar(0.0)))
        {
          return 0;
        }
    ...
    case 3:
    {
      ...
      if(!(f0 && f0->getDist2() > Scalar(0.0) && f1 && f1->getDist2() > Scalar(0.0) && f2
           && f2->getDist2() > Scalar(0.0) && f3 && f3->getDist2() > Scalar(0.0) && f4 && f4->getDist2() > Scalar(0.0)
...
#  if 1
         || yBuf[index] == yBuf[(*triangle)[0]] || yBuf[index] == yBuf[(*triangle)[1]]
