...
public:
   ...
   *  \ "qconvex.exe TI <input_filename> TO <output_filename> Qt o f" it will describe the convex hull of the polyhedric
   * shape of the stpbv \ (example: in the folder : "home\" there are two files ; the STP_BV file : "home\STPBV.txt",
   * and the Qhull output : "home\STPBV.txt.otp")
   *
   */
